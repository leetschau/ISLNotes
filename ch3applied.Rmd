...
```
The predictor *nox* has positive influence no *crim* in simple linear regression and negative influence in multiple linear regression. But the p-value of the t-stats of *nox* is 0.051152, which suggests *nox* has no siginificant influence on *crim*.
